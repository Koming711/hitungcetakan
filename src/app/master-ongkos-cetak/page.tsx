...
export default function MasterOngkosCetakPage() {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write('<th class="center">Gramatur</th>')
    ...
    filteredCosts.forEach((cost, index) => {
      printWindow.document.write(`
        <tr>
          ...
          <td class="center">${cost.grammage} gsm</td>
  ...
  const columns = [
    ...
    },
    {
      key: 'grammage',
      title: 'Gramatur',
      render: (cost: PrintingCost) => `${cost.grammage} gsm`
    },
    {
      key: 'printArea',
      title: 'Area Cetak (cm)',
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Kelola data ongkos cetak"
    >
